...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	cpaConfigStore := cpa.NewConfigStore(client)
	cpaStore := cpa.NewStore(client)
	cpaSyncer := provideCPASyncer(cpaStore, adminService)
	cpaRuntime := provideCPARuntime(cpaConfigStore, cpaSyncer)
	...
	cpaHandler := handler.ProvideCPAHandler(cpaConfigStore, cpaRuntime, cpaStore)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, cpaHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler)
