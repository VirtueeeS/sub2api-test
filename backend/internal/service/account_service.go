...
const AccountListSortByName = "name"
const AccountListSortByStatus = "status"
const AccountListSortBySchedulable = "schedulable"
const AccountListSortByPriority = "priority"
const AccountListSortByRateMultiplier = "rate_multiplier"
const AccountListSortByLastUsedAt = "last_used_at"
const AccountListSortByExpiresAt = "expires_at"
const AccountListSortByUsage = "usage"
const AccountListSortOrderAsc = "asc"
const AccountListSortOrderDesc = "desc"

func IsAccountListSortBySupported(sortBy string) bool {
	switch sortBy {
	case AccountListSortByName,
		AccountListSortByStatus,
		AccountListSortBySchedulable,
		AccountListSortByPriority,
		AccountListSortByRateMultiplier,
		AccountListSortByLastUsedAt,
		AccountListSortByExpiresAt,
		AccountListSortByUsage:
		return true
	default:
		return false
	}
...
func IsAccountListSortOrderSupported(sortOrder string) bool {
	switch sortOrder {
	case AccountListSortOrderAsc, AccountListSortOrderDesc:
		return true
	default:
		return false
	}
...
func NormalizeAccountListSortOrder(sortOrder string) string {
	if sortOrder == AccountListSortOrderAsc {
		return AccountListSortOrderAsc
	}
	return AccountListSortOrderDesc
}
...
type AccountRepository interface {
	...
	ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, search string, groupID int64, privacyMode string, sortArgs ...string) ([]Account, *pagination.PaginationResult, error)
