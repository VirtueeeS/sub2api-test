export default {
  ...
  admin: {
    ...
    cpa: {
      title: 'CPA Sync',
      description: 'Sync CPA auth files into accounts and review recent results.',
      summary: {
        enabled: 'Enabled',
        running: 'Running',
        interval: 'Interval',
      ...
      config: {
        ...
        description: 'Configure the watched directory, target group, and sync interval.',
        enabled: 'Enable Sync',
        sourceDir: 'Source Directory',
        groupId: 'Group ID',
      ...
      jobs: {
        title: 'Jobs',
        description: 'Recent CPA sync jobs.',
        triggerType: 'Trigger',
        status: 'Status',
        stats: 'Files/Created/Updated/Failed',
        updatedAt: 'Updated At',
        noData: 'No sync jobs yet.'
      },
      records: {
        title: 'Records',
        description: 'Per-file actions for the selected job.',
        filePath: 'File Path',
        action: 'Action',
        accountId: 'Account ID',
        processedAt: 'Processed At',
        noSelection: 'Select a job to load records.',
        noData: 'No records found for this job.'
      },
      files: {
        title: 'Files',
        description: 'Latest CPA file states and linked accounts.',
        filePath: 'File Path',
        ...
        noData: 'No tracked files yet.'
      },
      messages: {
        configSaved: 'CPA config saved.',
        runNowSuccess: 'CPA sync started.'
      }
    },
    usage: {
      title: 'Usage Records',
