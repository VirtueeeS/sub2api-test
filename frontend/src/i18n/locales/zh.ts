export default {
  ...
  admin: {
    ...
    cpa: {
      title: 'CPA 同步',
      description: '同步 CPA 授权文件到账号，并查看最近执行结果。',
      summary: {
        enabled: '启用状态',
        running: '运行中',
        interval: '同步间隔',
      ...
      config: {
        title: '同步配置',
        description: '配置监听目录、目标分组和同步频率。',
        enabled: '启用同步',
        sourceDir: '来源目录',
        groupId: '分组 ID',
        intervalSeconds: '间隔秒数',
        autoPauseOnError: '出错时自动暂停'
      },
      jobs: {
        title: '任务列表',
        description: '最近的 CPA 同步任务。',
        triggerType: '触发方式',
        status: '状态',
        stats: '扫描/创建/更新/失败',
        updatedAt: '更新时间',
      ...
      records: {
        title: '任务记录',
        description: '当前选中任务的逐文件处理结果。',
        filePath: '文件路径',
        action: '动作',
        accountId: '账号 ID',
        processedAt: '处理时间',
        noSelection: '请选择任务后查看记录。',
        noData: '该任务暂无记录。'
      },
      files: {
        title: '文件状态',
        description: 'CPA 文件最新状态及关联账号。',
        filePath: '文件路径',
        lastResult: '最近结果',
        linkedAccount: '关联账号',
        size: '大小',
        updatedAt: '更新时间',
        searchPlaceholder: '按文件路径搜索',
        allResults: '全部结果',
        noData: '暂无跟踪文件。'
      },
      messages: {
        configSaved: 'CPA 配置已保存。',
        runNowSuccess: 'CPA 同步已启动。'
      }
    },
    usage: {
      title: '使用记录',
